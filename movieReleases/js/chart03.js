					...
					.selectAll("rect")
					   ...
					   .on("mouseover", function( item, i ) {
						   $(element + "-infobox").css({
							...
							.html("<strong>" + item.date + "</strong><br /><br />Total Movies: <strong>" + movieToDates[ item.date ]+ "</strong><br/><br />Top Budget Movie(s): <strong>"+ item.movie.length +"</strong><br />" + item.movie.join("<br />"));
